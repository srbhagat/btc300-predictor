...
CACHE_FILE = os.path.join(DATA_DIR, "coindcx_btcusdt_15m_best_final.csv")
...
st.title("BTCUSDT 300-Point Best CoinDCX Predictor")
st.caption("Best stable version: CoinDCX-only data, fixed 300 TP, strict mathematical NO TRADE filter.")
