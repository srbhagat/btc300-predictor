...
st.title("BTCUSDT 300-Point Final CoinDCX Forward Predictor")
st.caption("Final CoinDCX version: forward time-window download, fixed 300 TP, strict mathematical NO TRADE filter.")
