...
st.title("BTCUSDT 300-Point Final Weighted Predictor")
st.caption("Final weighted version: 3-year history + recent-data weighting + CoinDCX live price + safe support/resistance.")
