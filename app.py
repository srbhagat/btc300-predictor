...
CACHE_FILE = os.path.join(DATA_DIR, "coindcx_btcusdt_15m_forward_final.csv")
...
st.title("BTCUSDT 300-Point Final CoinDCX Adaptive Predictor")
st.caption("Final adaptive CoinDCX version: forward database + adaptive historical matching + fixed 300 TP.")
