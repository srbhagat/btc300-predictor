...
CACHE_FILE = os.path.join(DATA_DIR, "coindcx_btcusdt_15m_final_tuned.csv")
...
def score_side(direction, res, latest, mtf, structure, support, resistance, price, tp, ctx):
    ...
    Fixed 300-point target blocking penalties are still applied.
    """
    reasons = []
...
st.title("BTCUSDT 300-Point Final Tuned Predictor")
st.caption("Final tuned version: CoinDCX forward database + adaptive matching + calibrated score + fixed 300 TP.")
